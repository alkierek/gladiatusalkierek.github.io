...
<td><a href="guild_library.php" class="awesome-tabs current">Biblioteca</a></td>
<td><a href="guild_libraryA.php" class="awesome-tabs">Administracion<div class="navBG"></div></a></td>
...
<?php include ('guild/library1.php'); ?>
