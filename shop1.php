...
<td><a href="shop1.php" class="awesome-tabs current">Vender</a></td>
<td><a href="forge.php" class="awesome-tabs">Herreria<div class="navBG"></div></a></td>
...
<?php
if (isset($_GET['move'])) {
	echo "<body><script type='text/javascript'>window.location='shop1.php';</script></body>";
}
if (isset($_POST['bestechen'])) {
	mysql_query("DELETE FROM sshop1 WHERE id = '".$userID."' ");
	echo "<body><script type='text/javascript'>window.location='';</script></body>";
}
?>
<?php
include ('items/sellShop.php');
?>
