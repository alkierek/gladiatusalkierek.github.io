...
if($item2 == 0){
	...
	if($itemBONUS == 2){
		$tableBONUSo = "<tr><td style=\'color:#00B712; font-weight: bold; font-size:8pt\' colspan=\'2\' nowrap=\'nowrap\'>$bonusOtext</td></tr>";
	...
	$tableC5 = $tableBONUSo . $tableBONUS . $tableLEVEL . $tableCOSTsell . $tableTIP . $tableUSE . $tableCLOSED;
