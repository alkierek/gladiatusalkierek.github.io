...
?>
<div id="content">
<?php mysql_query("UPDATE users SET user_rptsN = 0 WHERE user_id = '".$userID."' "); ?>
...
<td><?php if ($oro == 1) { ?><?php $oroganado1 = number_format($oroganado, 0, ",", "."); echo $oroganado1; ?> <img src="8501/img/res2.gif" title="Oro" align="absmiddle" border="0" /><?php } ?></td>
