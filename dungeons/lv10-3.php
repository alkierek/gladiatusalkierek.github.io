            ...
            <div style="position:relative;width:532px;height:400px">
                <img src="8501/img/dungeons/1.jpg" usemap="#city" width="532" height="400" style="border:none;" />
                                                    <img src="8501/img/dungeons/slices/1_4.jpg" style="position:absolute;left:74px;top:249px" />
                                                                    <map name="dmap">
                                                    <area shape="poly" href="#" coords="61, 239, 143, 239, 143, 315, 61, 315" onClick="startFight('4', '117100');showWait();return false;" style="cursor:pointer;"></area>                                                    <area shape="poly" href="#" coords="310, 294, 388, 294, 388, 357, 310, 357" onClick="startFight('5', '117100');showWait();return false;" style="cursor:pointer;"></area>                                            </map>
                    <img usemap="#dmap" src="8501/img/spacer.gif" width="532" height="400" style="position:absolute;left:0px;top:0px;border:none" />
                                                    <img onClick="startFight('4', '117100');showWait();return false;" src="8501/img/combatloc.gif" style="cursor:pointer;width:16px;height:16px;position:absolute;left:122px;top:276px"  onClick="startFight('4', '117100');showWait();return false;"/>                                    <img onClick="startFight('5', '117100');showWait();return false;" src="8501/img/combatloc.gif" style="cursor:pointer;width:16px;height:16px;position:absolute;left:368px;top:326px"  onClick="startFight('5', '117100');showWait();return false;"/>                                                                            <div class="map_label" style="cursor:pointer;left:142px;top:276px;"  onClick="startFight('4', '117100');showWait();return false;">5/5</div>                                            <div class="map_label" style="cursor:pointer;left:388px;top:326px;"  onClick="startFight('5', '117100');showWait();return false;">Jefe</div>                                                </div>
            </div>
