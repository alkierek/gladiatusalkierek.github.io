    ...
    <div style="margin:1px">
            ...
            <div style="position:relative;width:532px;height:400px">
                <img src="8501/img/dungeons/1.jpg" usemap="#city" width="532" height="400" style="border:none;" />
                                                    <img src="8501/img/dungeons/slices/1_1.jpg" style="position:absolute;left:180px;top:14px" />
                                    ...
                                    <img src="8501/img/dungeons/slices/1_4.jpg" style="position:absolute;left:74px;top:249px" />
                                                                    <map name="dmap">
                                                    <area shape="poly" href="#" coords="165, 8, 246, 8, 246, 59, 165, 59" onClick="startFight('1', '117100');showWait();return false;" style="cursor:pointer;"></area>                                            </map>
                    <img usemap="#dmap" src="8501/img/spacer.gif" width="532" height="400" style="position:absolute;left:0px;top:0px;border:none" />
                                                    <img onClick="startFight('1', '117100');showWait();return false;" src="8501/img/combatloc.gif" style="cursor:pointer;width:16px;height:16px;position:absolute;left:214px;top:35px"  onClick="startFight('1', '117100');showWait();return false;"/>                                                                            <div class="map_label" style="cursor:pointer;left:234px;top:35px;"  onClick="startFight('1', '117100');showWait();return false;">3/3</div>                                                </div>
            </div>
