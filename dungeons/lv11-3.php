    ...
    <div style="margin:1px">
            ...
            <div style="position:relative;width:532px;height:400px">
                <img src="8501/img/dungeons/23.jpg" usemap="#city" width="532" height="400" style="border:none;" />
                                                    <img src="8501/img/dungeons/slices/23_7.jpg" style="position:absolute;left:366px;top:76px" />
                                    <img src="8501/img/dungeons/slices/23_8.jpg" style="position:absolute;left:371px;top:32px" />
                                                                    <map name="dmap">
                                                    <area shape="poly" href="#" coords="366, 76, 439, 76, 439, 139, 366, 139" onClick="startFight('7', '118933');showWait();return false;" style="cursor:pointer;"></area>                                            </map>
                    <img usemap="#dmap" src="8501/img/spacer.gif" width="532" height="400" style="position:absolute;left:0px;top:0px;border:none" />
                                                    <img onClick="startFight('7', '118933');showWait();return false;" src="8501/img/combatloc.gif" style="cursor:pointer;width:16px;height:16px;position:absolute;left:409px;top:112px"  onClick="startFight('7', '118933');showWait();return false;"/>                                                                            <div class="map_label" style="cursor:pointer;left:429px;top:112px;"  onClick="startFight('7', '118933');showWait();return false;">1/2</div>                                                </div>
            </div>
